...
<div class="container text-center">
    ...
    <div class="alert alert-success my-3">
        <p class="lead py-3">Vous pouvez trouver ce projet à l'adresse suivante : <a href="http://reservalyon.jmvveb.fr" class="alert-link" rel="noopener noreferrer" target="_blank">http://reservalyon.jmvveb.fr.</a></p>
