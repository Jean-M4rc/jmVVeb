            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownCat">
                            ...
                            <a class="dropdown-item" href="{{ route('project', $project->slug) }}">{{ $project->name }}</a>                            @endforeach
                        </div>
                    </li>
                    @admin
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle{{ currentRoute(
                                                    ...
                                                    route('project.index'),
                                                    route('project.edit', request()->project?:0)
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ currentRoute(route('register')) }}" href="{{ route('register') }}">{{ __('Inscrition') }}</a>                        @endif
                    </li>
                    @else
                    <li class="nav-item dropdown">
